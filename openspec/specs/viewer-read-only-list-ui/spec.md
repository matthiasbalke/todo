# viewer-read-only-list-ui Specification

## Purpose

Define read-only list, grocery, item-detail, category, and membership behavior for viewer-role users while preserving non-mutating controls.
